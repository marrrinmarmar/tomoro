...
<main class="form-signin w-100 m-auto">
  <form class="needs-validation" novalidate action="proses/proses_login.php" method="POST">
    <img class="mb-4" src="kefein.png" alt="" width="150" height="50">

    <h1 class="h3 mb-3 fw-normal">Please login</h1>
 
    <div class="form-floating">
      <input name="username" type="email" required class="form-control" id="floatingInput" placeholder="name@example.com">
    ...
    <p class="mt-5 mb-3 text-body-secondary">&copy; marin</p>
  </form>
</main>
